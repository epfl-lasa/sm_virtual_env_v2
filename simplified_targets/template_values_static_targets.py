...
# tr_left = np.array([PX_BORDER, 
#                     PX_HEIGHT_OFFSET + PX_WS_HEIGHT // 2, 
#                     orientation_default])

# tr_right = np.array([PX_WS_WIDTH-PX_BORDER, 
#                      PX_HEIGHT_OFFSET + PX_WS_HEIGHT // 2, 
#                      orientation_default])
...
dict_template_moving_target = {
    "name": None, 
    "initial_pose": None, "final_pose": None, 
    "speed": None,
    "t_start": None
}